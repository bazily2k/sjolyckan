...
const LABELS = {
  sv: {
    ...
    pets_note:'Husdjur är välkomna — vi ber dig ange antal för kostnadsberäkning och planering.',
  ...
  en: {
    ...
    pets_note:'Pets are welcome — please let us know how many for cost calculation and planning.',
  ...
  de: {
    ...
    pets_note:'Haustiere sind willkommen — bitte Anzahl für Kostenberechnung und Planung angeben.',
    ...
    return (
      <div style={card}>
        <div style={{ textAlign:'center', padding:'8px 0 16px' }}>
          ...
          <p style={{ fontSize:12, color:'var(--ink-light)', marginTop:8, fontStyle:'italic' }}>{t('confirm.spam_note')}</p>
        </div>
