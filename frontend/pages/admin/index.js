...
export default function Home({ locale }) {
  ...
  const scrollToId = (id) => {
    ...
    // Om elementet är dolt (t.ex. desktop-kalender på mobil), leta synlig motsvarighet
      ...
      <section style={{ position:'relative', height:'100vh', minHeight:600, overflow:'hidden' }}>
        ...
        <div style={{ position:'relative', height:'100%', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', textAlign:'center', color:'white', padding:'0 24px' }}>
          ...
          <div style={{ display:'flex', gap:12, flexWrap:'wrap', justifyContent:'center' }}>
            <a onClick={() => scrollToId('boka')} style={{ cursor:'pointer', padding:'14px 36px', background:'white', color:'var(--ink)', borderRadius:'var(--radius-xl)', fontSize:15, fontWeight:500, boxShadow:'0 4px 20px rgba(0,0,0,0.2)' }}>
              {t('hero.cta')} ↓
            </a>
      ...
      <section id="boka" style={{ padding:'56px 24px', maxWidth:1100, margin:'0 auto' }}>
        <div style={{ display:'grid', gridTemplateColumns:'minmax(0,1fr) 340px', gap:48 }}>
          ...
          <div style={{ alignSelf:'start' }}>
            ...
            <div className="mobile-calendar" id="kalender-mobil">
              <AvailabilityCalendar lang={lang} onSelectDates={handleSelectDates} />
            </div>
            <div ref={bookingRef}>
